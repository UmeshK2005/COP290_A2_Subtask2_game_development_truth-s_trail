...
def level2_game(screen, screen_width, screen_height):
    ...
    background_path = "useful_images/img_8.png"  
    ...
    first_option = pygame.transform.scale(first_option, (478,72))
    first_option_enlarged_image = pygame.transform.scale(first_option, (520,100))
    second_option_size = ((int(second_option.get_width() * 1.05)//4), int((second_option.get_height() * 1.05)//4))
    second_option = pygame.transform.scale(second_option, (478,72))
    second_option_enlarged_image = pygame.transform.scale(second_option, (520,100))
    third_option_size = (int((third_option.get_width() * 1.05)//4), int((third_option.get_height() * 1.05)//4))
    third_option = pygame.transform.scale(third_option, (478,72))
    third_option_enlarged_image = pygame.transform.scale(third_option, (520,100))
    ...
    while running:
        ...
        # Draw the play button
          # Draw the enlarged play button
        if is_over_option(mouse_pos)!=1:
            screen.blit(first_option, (786,96))  # Draw the normal size play button
        
        if is_over_option(mouse_pos)!=2:
            screen.blit(second_option, (788,181))
        if is_over_option(mouse_pos)!=3:
            screen.blit(third_option, (790,259))
            
            
        if is_over_option(mouse_pos)==1:
            screen.blit(first_option_enlarged_image, (786,96))
        elif is_over_option(mouse_pos)==2:
            screen.blit(second_option_enlarged_image, (786,181))
        elif is_over_option(mouse_pos)==3:
            screen.blit(third_option_enlarged_image, (786,259))
